from helper_functions import  heuristic_value, calculate_connections
import heapq
from copy import deepcopy


# Note: if it isn't possible to get from one point to another, -1 is returned
# The map is split into 3 areas - explored, unexplored and frontier
# The node with the smallest a_star_value is always chosen
def shortest_path( connection_list, start_point, end_point):
    heuristic_values = heuristic_value()
    connection_distances = calculate_connections()
